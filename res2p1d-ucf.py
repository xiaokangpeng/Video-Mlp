...
from backbone.back_bone import *
import argparse
...
def main():
    ...
    parser.add_argument('-m', '--model', type=str, default='r2plus1d_18', help='resLP | attention')
    ...
    scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[50, 90], gamma=0.1)

    train_data = Dataset('/home/share/GSAI-M3PL-Lab/UCF101/ucf101-frames-1fps/video-set/', './dataset', 'UCF_train.csv')
    train_loader = DataLoader(dataset=train_data, shuffle=True, batch_size=batch_size, num_workers=16,pin_memory=True)
    test_data = Dataset('/home/share/GSAI-M3PL-Lab/UCF101/ucf101-frames-1fps/video-set/', './dataset',
                                'UCF_test.csv')
