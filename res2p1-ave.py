...
import numpy as np
writer = SummaryWriter(comment='res2p1')
...
def main():
    parser = argparse.ArgumentParser(description="r2plus1d_18 training")
    parser.add_argument('-m', '--model', type=str, default='r2plus1d_18', help='r2plus1d_18 | attention')
